              ...
              <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px;">
                <div style="display: flex; align-items: center; gap: 12px; min-width: 0; flex: 1;">
                  ...
                  <div style="text-align: left; color: white; font-size: 12px; line-height: 1.4;">
                    🎶 <span style="font-weight: bold;">listening to:</span> 銀座ウィンドウショッピング　（Ｇｉｎｚａ　Ｗｉｎｄｏｗ　Ｓｈｏｐｐｉｎｇ） by: NEON CITYPOP JAPAN 🎶 <br/>
                    1:32 ━━━━●─────────── 4:40 <br/>
                    Volume: ■□□□□□□□ <br/>
                    <span>↻      ◁ ⏸ ▷     ↺ </span>
                  </div>
...
<div align="center">
  <sub>🤖 Auto-updated via GitHub Actions • Last sync: Jan 24, 2026, 06:57 AM</sub>
</div>
