            ...
            <div style="background: #181818; border: 1px solid #282828; border-radius: 8px; padding: 16px; min-width: 350px; max-width: 400px;" align="center">
              <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px;">
                <div style="display: flex; align-items: center; gap: 12px; min-width: 0; flex: 1;">
                  <img src="https://i.scdn.co/image/ab67616d0000b27374a94c8c0c6b1e9f38ff7cfe" width="240" height="240" style="border-radius: 6px; object-fit: cover; flex-shrink: 0;" alt="Album Art" />
                  <div style="text-align: left; color: white; font-size: 12px; line-height: 1.4;">
                    🎶 <span style="font-weight: bold;">listening to:</span> Love For You by: LOVELI LORI 🎶 <br/>
                    1:03 ━━━━●─────────── 3:44 <br/>
                    Volume: ■■■■■□□□ <br/>
                    <span>↻      ◁ ⏸ ▷     ↺ </span>
                  </div>
...
<div align="center">
  <sub>🤖 Auto-updated via GitHub Actions • Last sync: Jan 26, 2026, 01:23 AM</sub>
</div>
